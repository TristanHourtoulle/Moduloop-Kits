                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {onUpdateQuantity && (
                        <Button
                          ...
                          onClick={() =>
                            onStartEditing(projectKit.id, projectKit.quantite)
                          }
                ...
                <>
                  ...
                  {kit.surfaceM2 && kit.surfaceM2 > 0 && (
                    <div className="text-xs text-gray-500 mt-1">
                      {ceilPrice(kitPrice / kit.surfaceM2).toLocaleString(
                        'fr-FR',
                        { minimumFractionDigits: 0, maximumFractionDigits: 2 },
                      )}
                      €/m²
                      <span className="text-gray-400 ml-1">
                        ({(kit.surfaceM2 * projectKit.quantite).toFixed(1)} m²
                        total)
                      </span>
                    </div>
                  )}
                  <div className="text-xs text-gray-500 mt-1">Achat</div>
                </>
              ) : (
                <>
                      ...
                      return (
                        <>
                          ...
                          {kit.surfaceM2 &&
                            kit.surfaceM2 > 0 &&
                            (() => {
                              const annualPerM2 = ceilPrice(
                                price3ans / kit.surfaceM2,
                              )
                              ...
                              return (
                                <div className="text-xs text-gray-500 mt-2 pt-2 border-t border-gray-200">
                                  ...
                                  <div className="text-gray-400 mt-1">
                                    {(
                                      kit.surfaceM2 * projectKit.quantite
                                    ).toFixed(1)}{' '}
                                    m² total
                                  </div>
                                </div>
                          ...
                          <div className="bg-gray-50 rounded-lg p-3 border border-gray-100">
                            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-700 truncate">
                                  {(
                                    (productImpact.eutrophisation || 0) *
                                    kitProduct.quantite
                                  ).toFixed(1)}{' '}
