                            ...
                            <div className='p-6'>
                              ...
                              <div className='grid grid-cols-4 gap-2 mb-4'>
                                <div className='text-center p-2 bg-red-50 rounded-lg'>
                                  <Zap className='w-3 h-3 text-red-500 mx-auto mb-1' />
                                ...
                                <div className='text-center p-2 bg-orange-50 rounded-lg'>
                                  <Target className='w-3 h-3 text-orange-500 mx-auto mb-1' />
                                ...
                                <div className='text-center p-2 bg-green-50 rounded-lg'>
                                  <Leaf className='w-3 h-3 text-green-500 mx-auto mb-1' />
                  ...
                  <CardContent className='space-y-4 relative z-10'>
                    ...
                    {selectedMode === 'location' && (
                      <>
                        ...
                        >
                          <div className='w-8 h-8 bg-gradient-to-br from-red-100 to-pink-100 rounded-lg flex items-center justify-center mx-auto mb-2'>
                            <Zap className='w-4 h-4 text-red-600' />
                          </div>
                          <div className='text-sm font-bold text-red-900 mb-1'>
                            {totalImpact.rechauffementClimatique.toFixed(1)}
                          </div>
                          <div className='text-xs text-red-700'>kg CO₂ économisés</div>
                        </motion.div>

                        <motion.div
                          whileHover={{ y: -2, scale: 1.02 }}
                          className='text-center p-4 bg-gradient-to-br from-orange-50 to-yellow-50 border border-orange-100 rounded-xl shadow-sm hover:shadow-md transition-all duration-200'
                        >
                          <div className='w-8 h-8 bg-gradient-to-br from-orange-100 to-yellow-100 rounded-lg flex items-center justify-center mx-auto mb-2'>
                            <Target className='w-4 h-4 text-orange-600' />
                          </div>
                          <div className='text-sm font-bold text-orange-900 mb-1'>
                            {totalImpact.epuisementRessources.toFixed(0)}
                          </div>
                          <div className='text-xs text-orange-700'>MJ économisés</div>
                        </motion.div>

                        <motion.div
                          whileHover={{ y: -2, scale: 1.02 }}
                          className='text-center p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-100 rounded-xl shadow-sm hover:shadow-md transition-all duration-200'
                        >
                          <div className='w-8 h-8 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg flex items-center justify-center mx-auto mb-2'>
                            <Droplets className='w-4 h-4 text-blue-600' />
                          </div>
                          <div className='text-sm font-bold text-blue-900 mb-1'>
                            {totalImpact.acidification.toFixed(1)}
                          </div>
                          <div className='text-xs text-blue-700'>MOL H+ économisés</div>
                        </motion.div>

                        <motion.div
                          whileHover={{ y: -2, scale: 1.02 }}
                          className='text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100 rounded-xl shadow-sm hover:shadow-md transition-all duration-200'
                        >
                          <div className='w-8 h-8 bg-gradient-to-br from-green-100 to-emerald-100 rounded-lg flex items-center justify-center mx-auto mb-2'>
                            <Leaf className='w-4 h-4 text-green-600' />
                          </div>
                          <div className='text-sm font-bold text-green-900 mb-1'>
                            {totalImpact.eutrophisation.toFixed(1)}
                          </div>
                          <div className='text-xs text-green-700'>kg P eq économisés</div>
                        </motion.div>
                      </div>
                      </>
                    )}
