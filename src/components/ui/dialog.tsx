...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-center sm:text-left pb-4 border-b border-border/20",
      className
    )}
    {...props}
  />
