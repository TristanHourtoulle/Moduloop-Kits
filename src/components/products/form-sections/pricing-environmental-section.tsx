      ...
      <div className="space-y-6 mb-2">
        ...
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <p className="text-xs text-blue-700">
            Pour les achats de produits neufs, l&apos;impact environnemental
            n&apos;est pas saisi ici. Il sera géré ailleurs dans le système.
          </p>
        </div>
      </div>
    )
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            ...
            <p className="text-xs text-green-700">
              Ces valeurs représentent la <strong>différence</strong>{' '}
              d&apos;impact environnemental entre la location (réutilisation
              d&apos;équipements existants) et l&apos;achat neuf. Vous saisissez
              directement la différence finale calculée.
            </p>
          </div>
        </div>
      </div>
