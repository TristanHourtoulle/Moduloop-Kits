...
export function cleanProductDataForForm(data: Record<string, unknown>) {
  ...
  const optionalNumericFields = [
    ...
    'prixUnitaireAchat2Ans',
    'prixUnitaireAchat3Ans',
    'prixVenteAchat1An',
    'prixVenteAchat2Ans',
    'prixVenteAchat3Ans',
    'margeCoefficientAchat',

    'prixAchatLocation1An',
    'prixAchatLocation2Ans',
    'prixAchatLocation3Ans',
    'prixUnitaireLocation1An',
    'prixUnitaireLocation2Ans',
    'prixUnitaireLocation3Ans',
    'prixVenteLocation1An',
    'prixVenteLocation2Ans',
    'prixVenteLocation3Ans',
    ...
    'acidificationLocation',
    'eutrophisationLocation',
  ]
